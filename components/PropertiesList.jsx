...
export default function PropertiesList({ property: { coverPhoto, price, rentFrequency, rooms, title, baths, area, agency, isVerified, externalID  } }) {
    return (
        <Link href="/" passHref>
            <Flex flexWrap="wrap" w="420px" p="2">
                <Box>
